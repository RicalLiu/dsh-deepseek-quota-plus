 ...
 *
 * 移植自 dsh-deepseek-quota lib/pricing.js(MIT):
 * https://github.com/yingjunnan/dsh-deepseek-quota
 * 原实现移植自 bpc-oss/dsh-web-billing(MIT):
 ...
 * (`prices`),要么是峰谷单价表(`peak`/`offPeak`)。新政策通过追加条目生效——
 * `since` 最晚且不晚于消息时间的政策胜出。
 */
